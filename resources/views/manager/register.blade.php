        ...
        <div class="row h-100 justify-content-center align-items-center">
            <div class="col-md-8">
               <div class="card border border-success">
                <div class="card-header text-white text-uppercase h4" style="background: #6DAD29;">REGISTRETION FORM</div>
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row mb-0">
                            <div class="col-md-6 offset-md-4">
                                <button type="submit" class="btn  font-weight-bold" style="background: #6DAD29; color: #fff;">
                                    {{ __('Register') }}
                                </button>
                            </div>
                        </div>
